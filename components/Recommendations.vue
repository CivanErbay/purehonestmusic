  ...
  <DefaultGrid>
    <div class="lg:col-start-3 lg:col-end-11 mt-5 lg:mt-10">
      ...
      <div class="flex flex-col lg:flex-row gap-x-8 relative">
            ...
            <div class="flex items-end text-white text-xs">
              <div class="w-1/2 p-3 pb-4">
                <div class="flex">
                  ...
                  <p class="ml-1 opacity-40">{{ weekDay(item.date) }}, {{ formattedDate(item.date) }}</p>
                </div>
                <div class="flex my-4 ">
        ...
        <div class="absolute h-full w-10 bg-[#242424] -right-12 top-0 hidden lg:flex items-center justify-center rounded-xl cursor-pointer">
